 ...
 * @returns {JSX.Element}
 */var StickyRegion_StickyRegion=function StickyRegion(_ref){var children=_ref.children,className=_ref.className,_onDoubleClick=_ref.onDoubleClick,props=(0,objectWithoutProperties/* default */.Z)(_ref,StickyRegion_excluded);var _useState=(0,index_js_.useState)(false),_useState2=(0,slicedToArray/* default */.Z)(_useState,2),dragOver=_useState2[0],setDragOver=_useState2[1];var _useContext=(0,index_js_.useContext)(DeleteContext),callback=_useContext.callback;return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:dedupe_default()("delete-region h-16 bg-red block w-full text-center text-2xl py-4 text-white fixed top-0 left-0 z-10 opacity-0",{"opacity-50":dragOver}),onDragOver:function onDragOver(e){setDragOver(true);e.preventDefault();},onDragLeave:function onDragLeave(){setDragOver(false);},onDrop:function onDrop(){if(typeof callback==="function"){callback();}setDragOver(false);},children:"Drop Note to Delete"}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",(0,objectSpread2/* default */.Z)((0,objectSpread2/* default */.Z)({},props),{},{className:dedupe_default()(className,"bg-gray-200 block sticky-region cursor-pointer"),onDoubleClick:function onDoubleClick(e){_onDoubleClick({x:e.clientX,y:e.clientY});},children:children}))]});};
...
//# sourceMappingURL=src_bootstrap_js.4ff00675.chunk.js.map